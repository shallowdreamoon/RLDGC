...
import time
from utils import load_mat_data, normalize_adj_1
    ...
    for epoch in range(args.max_epoch):
        ...
        with torch.no_grad():
            ...
            if consecutive_epoch > args.patience:
                bestmodel_path = os.path.join(args.premodel_path, "premodel_{}_{}.pkl".format(dataset, best_epoch))
                torch.save(best_model, bestmodel_path)
                bestres_path = os.path.join(args.premodel_path, "premodel_{}_{}_bestres.txt".format(dataset, best_epoch))
...
if __name__ == '__main__':
    ...
    premodel_path = r"E:\study\pycharm\GRL_Study\RL_Policy-GNN_V2\pretrain_res\{}".format(args.dataset)
